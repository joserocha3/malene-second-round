...
<template>
  <div class="pt-12 bg-gradient-to-tl from-green-200 via-green-300 to-blue-500 min-h-screen">
    <div class="p-8 md:p-20">
      ...
      <input class="mt-8 w-full px-4 py-2 border rounded flex-shrink" v-model="searchTerm" placeholder="Search albums...">
      <div class="flex gap-2 mt-4">
        ...
        <label for="favorite-filter" class="duration-500 transform hover:-translate-y-1">
          ...
          <div v-else class="px-6 py-3 rounded-lg bg-neutral-100 border bg-opacity-90 hover:bg-opacity-100 flex gap-2 items-center text-sm">
